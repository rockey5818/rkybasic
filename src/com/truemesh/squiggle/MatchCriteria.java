...
public class MatchCriteria extends Criteria
{
    ...
    public MatchCriteria(Table table, String colName, String matchType, boolean value)
    {
        this(table.getColumn(colName), matchType, value);
    }
     ...
     *            the date literal to use in the comparison.
     */
    public MatchCriteria(Table table, String colName, String operator, Date operand)
    {
        this(table.getColumn(colName), operator, operand);
    }

    public MatchCriteria(Table table, String colName, String matchType, long value)
    {
        this(table.getColumn(colName), matchType, value);
    }

    public MatchCriteria(Table table, String colName, String matchType, int value)
    {
        this(table.getColumn(colName), matchType, value);
    }

    public MatchCriteria(Table table, String colName, String matchType, String value)
    {
        this(table.getColumn(colName), matchType, value);
    }
